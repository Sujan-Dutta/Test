    ...
    <div class="container-fluid">
      <div class="row justify-content-center section-title">
        <div class="col-lg-12">
		  ...
		  <div><form action="faculty1.jsp" method="post"><table>
		  <input type="hidden" value="Faculty" name="role">
		  <tr><td><input type="text" name="email" id="email" placeholder="Email ID" required ></td></tr>
		  ...
		  <!--<tr><td><a href="register.jsp" class="button">Register</a></td></tr>-->
		  </form><div>
        </div>
      </div>
    </div>
